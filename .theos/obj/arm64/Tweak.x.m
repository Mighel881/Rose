...
@class SpringBoard; @class SBUIIconForceTouchController; @class SBCoverSheetPrimarySlidingViewController; @class SBMainDisplaySceneManager; @class SBSleepWakeHardwareButtonInteraction; @class VolumeControl; @class SBUIController; @class SBAppSwitcherPageView; @class SBPowerDownController; @class SiriUISiriStatusView; 
