...
@class SBSleepWakeHardwareButtonInteraction; @class SBAppSwitcherPageView; @class SBUIIconForceTouchController; @class SBUIController; @class VolumeControl; @class SpringBoard; @class SBPowerDownController; @class SBMainDisplaySceneManager; @class SBCoverSheetPrimarySlidingViewController; @class SiriUISiriStatusView; 
