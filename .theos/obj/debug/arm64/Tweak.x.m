...
@class UICalloutBar; @class SPTNowPlayingFreeTierFeedbackButton; @class SPTNowPlayingShuffleButton; @class SBAppSwitcherPageView; @class SBDashBoardViewController; @class VolumeControl; @class UIKeyboardLayoutStar; @class UIKBTree; @class SPTNowPlayingPlayButtonV2; @class ICSApplicationDelegate; @class IGUFIButtonBarView; @class SBFolderView; @class SBCoverSheetPrimarySlidingViewController; @class SBSleepWakeHardwareButtonInteraction; @class SBPowerDownViewController; @class SBBacklightController; @class SPTNowPlayingMarqueeLabel; @class SPTNowPlayingNextTrackButton; @class SBSearchScrollView; @class UIWindow; @class CCUIToggleViewController; @class SBPowerDownController; @class SBVolumeControl; @class SBDashBoardMesaUnlockBehavior; @class SBHIconManager; @class CCUILabeledRoundButton; @class SBUIIconForceTouchController; @class AWEFeedVideoButton; @class SPTGaiaDevicesAvailableViewImplementation; @class SBMainDisplaySceneManager; @class SBUIController; @class SPTNowPlayingRepeatButton; @class SpringBoard; @class SBIconController; @class SPTNowPlayingPreviousTrackButton; @class SBUIPasscodeLockViewBase; @class SPTNowPlayingSliderV2; @class SSScreenCapturer; @class SBFolderController; @class SPTNowPlayingQueueButton; @class SBControlCenterController; @class SiriUISiriStatusView; 
...
static void _logos_method$Rose$IGUFIButtonBarView$_onExternalShareButtonPressed$(_LOGOS_SELF_TYPE_NORMAL IGUFIButtonBarView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1) {

	_logos_orig$Rose$IGUFIButtonBarView$_onExternalShareButtonPressed$(self, _cmd, arg1);
...
static void _logos_method$Rose$IGUFIButtonBarView$_onRelatedPostsButtonPressed$(_LOGOS_SELF_TYPE_NORMAL IGUFIButtonBarView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1) {

	_logos_orig$Rose$IGUFIButtonBarView$_onRelatedPostsButtonPressed$(self, _cmd, arg1);
...
static void _logos_method$Rose$IGUFIButtonBarView$_onReplyButtonPressed$(_LOGOS_SELF_TYPE_NORMAL IGUFIButtonBarView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1) {

	_logos_orig$Rose$IGUFIButtonBarView$_onReplyButtonPressed$(self, _cmd, arg1);
...
static __attribute__((constructor)) void _logosLocalCtor_423c86e0(int __unused argc, char __unused **argv, char __unused **envp) {
...
static __attribute__((constructor)) void _logosLocalCtor_efb53d77(int __unused argc, char __unused **argv, char __unused **envp) {
