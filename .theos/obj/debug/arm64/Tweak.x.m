...
@class SBUIController; @class SPTNowPlayingNextTrackButton; @class AWEFeedVideoButton; @class SSScreenCapturer; @class SPTNowPlayingMarqueeLabel; @class ICSApplicationDelegate; @class UIKBTree; @class TFNFloatingActionButton; @class T1StandardStatusView; @class UIKeyboardLayoutStar; @class T1DirectMessageInboxSummaryView; @class SBFolderView; @class SPTNowPlayingShuffleButton; @class SPTGaiaDevicesAvailableViewImplementation; @class CCUILabeledRoundButton; @class SBIconController; @class SBBacklightController; @class SBFolderController; @class SBVolumeControl; @class SPTNowPlayingPreviousTrackButton; @class SpringBoard; @class VolumeControl; @class UICalloutBar; @class CCUIToggleViewController; @class SBSearchScrollView; @class IGUFIButtonBarView; @class SBDashBoardMesaUnlockBehavior; @class SBDashBoardViewController; @class SBPowerDownController; @class SBMainDisplaySceneManager; @class SPTNowPlayingFreeTierFeedbackButton; @class SPTNowPlayingRepeatButton; @class SPTNowPlayingQueueButton; @class SBCoverSheetPrimarySlidingViewController; @class SBPowerDownViewController; @class TFNCustomTabBar; @class T1ActivityCell; @class SBAppSwitcherPageView; @class SPTNowPlayingSliderV2; @class SBUIIconForceTouchController; @class SBControlCenterController; @class UIWindow; @class SiriUISiriStatusView; @class SBUIPasscodeLockViewBase; @class SPTNowPlayingPlayButtonV2; @class SBSleepWakeHardwareButtonInteraction; @class SBHIconManager; 
