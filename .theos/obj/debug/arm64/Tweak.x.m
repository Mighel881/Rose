...
@class SBSearchScrollView; @class SBDashBoardMesaUnlockBehavior; @class SBVolumeControl; @class SBAppSwitcherPageView; @class SBDashBoardViewController; @class SBUIPasscodeLockViewBase; @class SBUIController; @class SBSleepWakeHardwareButtonInteraction; @class SBBacklightController; @class SBCoverSheetPrimarySlidingViewController; @class SBFolderView; @class SBFolderController; @class SBIconController; @class SBUIIconForceTouchController; @class UIWindow; @class UIKeyboardLayoutStar; @class SBPowerDownViewController; @class UIKBTree; @class SSScreenCapturer; @class VolumeControl; @class SpringBoard; @class SBPowerDownController; @class SiriUISiriStatusView; @class CCUILabeledRoundButton; @class SBHIconManager; @class UICalloutBar; @class SBMainDisplaySceneManager; @class ICSApplicationDelegate; 
