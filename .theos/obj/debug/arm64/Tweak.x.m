...
@class SBAppSwitcherPageView; @class SiriUISiriStatusView; @class SBDashBoardViewController; @class SBSleepWakeHardwareButtonInteraction; @class SBPowerDownController; @class ICSApplicationDelegate; @class SBSearchScrollView; @class SBIconController; @class SBVolumeControl; @class VolumeControl; @class UIWindow; @class UIKBRenderConfig; @class UIKeyboardLayoutStar; @class SBMainDisplaySceneManager; @class UIKBTree; @class SBUIPasscodeLockViewBase; @class SBFolderView; @class SBCoverSheetPrimarySlidingViewController; @class SBUIIconForceTouchController; @class UICalloutBar; @class SBUIController; @class CCUILabeledRoundButton; @class SSScreenCapturer; @class SpringBoard; @class SBHIconManager; @class SBBacklightController; @class SBFolderController; @class SBDashBoardMesaUnlockBehavior; @class SBPowerDownViewController; 
