...
@class SBPowerDownController; @class UICalloutBar; @class SBBacklightController; @class SBSearchScrollView; @class SBUIPasscodeLockViewBase; @class SBMainDisplaySceneManager; @class SBUIController; @class VolumeControl; @class SpringBoard; @class SiriUISiriStatusView; @class SBIconController; @class SBFolderController; @class ICSApplicationDelegate; @class UIKeyboardLayoutStar; @class UIWindow; @class SBDashBoardViewController; @class CCUILabeledRoundButton; @class SBUIIconForceTouchController; @class SBCoverSheetPrimarySlidingViewController; @class SBSleepWakeHardwareButtonInteraction; @class SBAppSwitcherPageView; @class SSScreenCapturer; @class SBFolderView; @class UIKBTree; 
