...
@class SBUIPasscodeLockViewBase; @class SBPowerDownController; @class SSScreenCapturer; @class SBCoverSheetPrimarySlidingViewController; @class SBUIIconForceTouchController; @class SBSleepWakeHardwareButtonInteraction; @class VolumeControl; @class SBIconController; @class SpringBoard; @class SBUIController; @class UIKBTree; @class SBFolderView; @class SBAppSwitcherPageView; @class SBMainDisplaySceneManager; @class SiriUISiriStatusView; @class UIKeyboardLayoutStar; @class SBFolderController; @class CCUILabeledRoundButton; 
