...
@class SBIconController; @class UIKeyboardLayoutStar; @class CNContactListTableViewCell; @class SBSearchScrollView; @class SBPowerDownController; @class UIImageView; @class SBUIIconForceTouchController; @class UIWindow; @class SBDashBoardMesaUnlockBehavior; @class ICSApplicationDelegate; @class SBControlCenterController; @class SBUIController; @class T1StandardStatusView; @class UIButton; @class T1ActivityCell; @class SPTNowPlayingPlayButtonV2; @class UICalloutBar; @class SBDashBoardViewController; @class PHHandsetDialerNumberPadButton; @class SBHIconManager; @class _UIButtonBarButton; @class SPTNowPlayingNextTrackButton; @class SSScreenCapturer; @class SBVolumeControl; @class MTMaterialView; @class SBFolderView; @class UIView; @class SPTNowPlayingQueueButton; @class SPTNowPlayingMarqueeLabel; @class SPTNowPlayingPreviousTrackButton; @class NSProcessInfo; @class TFNCustomTabBar; @class SBBacklightController; @class TFNFloatingActionButton; @class SBSleepWakeHardwareButtonInteraction; @class SpringBoard; @class SBFolderController; @class SiriUISiriStatusView; @class PHHandsetDialerDeleteButton; @class UIVisualEffectView; @class SBCoverSheetPrimarySlidingViewController; @class SPTNowPlayingSliderV2; @class SBMainDisplaySceneManager; @class IGUFIButtonBarView; @class SBAppSwitcherPageView; @class CCUILabeledRoundButton; @class AWEFeedVideoButton; @class SPTNowPlayingShuffleButton; @class SBUIPasscodeLockViewBase; @class T1DirectMessageInboxSummaryView; @class _SFNavigationBarURLButton; @class UILabel; @class SPTGaiaDevicesAvailableViewImplementation; @class PHBottomBarButton; @class SPTNowPlayingRepeatButton; @class VolumeControl; @class CCUIToggleViewController; @class UIStackView; @class UIKBTree; @class SPTNowPlayingFreeTierFeedbackButton; @class SBPowerDownViewController; 
...
static __attribute__((constructor)) void _logosLocalCtor_10387d13(int __unused argc, char __unused **argv, char __unused **envp) {
...
static __attribute__((constructor)) void _logosLocalCtor_bc79cf3b(int __unused argc, char __unused **argv, char __unused **envp) {
