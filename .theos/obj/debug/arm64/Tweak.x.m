...
@class VolumeControl; @class CNContactListTableViewCell; @class SPTNowPlayingPreviousTrackButton; @class MTMaterialView; @class TFNFloatingActionButton; @class MusicApplicationContextualActionsButton; @class UIImageView; @class T1DirectMessageInboxSummaryView; @class UILabel; @class SBSleepWakeHardwareButtonInteraction; @class SBHIconManager; @class SPTNowPlayingFreeTierFeedbackButton; @class SPTNowPlayingRepeatButton; @class SBCoverSheetPrimarySlidingViewController; @class ICSApplicationDelegate; @class SPTNowPlayingNextTrackButton; @class MusicApplicationAlbumCell; @class SBPowerDownViewController; @class MusicApplicationSongCell; @class SPTGaiaDevicesAvailableViewImplementation; @class SPTNowPlayingPlayButtonV2; @class SpringBoard; @class SileoTableViewCell; @class PHHandsetDialerNumberPadButton; @class PHBottomBarButton; @class _TtCC16MusicApplication30LibraryMenuTableViewController4Cell; @class T1ActivityCell; @class SBFolderView; @class MusicApplicationTimeSlider; @class UIStackView; @class SBControlCenterController; @class CCUIToggleViewController; @class SPTNowPlayingShuffleButton; @class CCUILabeledRoundButton; @class SBUIPasscodeLockViewBase; @class _UIButtonBarButton; @class T1StandardStatusView; @class SBUIController; @class FBTabBar; @class SBVolumeControl; @class MusicApplicationPlayButton; @class UIVisualEffectView; @class FDSTetraPressStateAnnouncingControl; @class UIKBTree; @class SiriUISiriStatusView; @class _TtCC16MusicApplication32NowPlayingControlsViewController12VolumeSlider; @class AWEFeedVideoButton; @class FBNavigationBarButton; @class SBMainDisplaySceneManager; @class SBIconController; @class MPButton; @class UIKeyboardLayoutStar; @class SBSearchScrollView; @class UIButton; @class PHHandsetDialerDeleteButton; @class TFNCustomTabBar; @class SSScreenCapturer; @class SPTNowPlayingMarqueeLabel; @class SBFolderController; @class SileoConfirmDownloadButton; @class SPTNowPlayingQueueButton; @class IGUFIButtonBarView; @class SBDashBoardMesaUnlockBehavior; @class SBPowerDownController; @class MPRouteButton; @class UIWindow; @class SBAppSwitcherPageView; @class CalculatorApplicationKeyPadButton; @class SBDashBoardViewController; @class SBUIIconForceTouchController; @class NSProcessInfo; @class SPTNowPlayingSliderV2; @class _SFNavigationBarURLButton; @class UICalloutBar; @class SileoFeaturedBannerView; @class UIView; @class SileoSourcesCell; @class SBBacklightController; @class SileoPackageCollectionViewCell; @class SPTNowPlayingBarPlayButton; 
...
static __attribute__((constructor)) void _logosLocalCtor_a6f210ca(int __unused argc, char __unused **argv, char __unused **envp) {
...
static __attribute__((constructor)) void _logosLocalCtor_79ed8a28(int __unused argc, char __unused **argv, char __unused **envp) {
...
static __attribute__((constructor)) void _logosLocalCtor_0bbb3d5e(int __unused argc, char __unused **argv, char __unused **envp) {
...
static __attribute__((constructor)) void _logosLocalCtor_3658243f(int __unused argc, char __unused **argv, char __unused **envp) {
