...
@class SBUIIconForceTouchController; @class VolumeControl; @class UIKBTree; @class SBSleepWakeHardwareButtonInteraction; @class SpringBoard; @class SBUIPasscodeLockViewBase; @class SiriUISiriStatusView; @class SBFolderController; @class SBPowerDownController; @class SBMainDisplaySceneManager; @class SBCoverSheetPrimarySlidingViewController; @class SBIconController; @class SSScreenCapturer; @class UIKeyboardLayoutStar; @class SBAppSwitcherPageView; @class SBUIController; @class SBFolderView; @class CCUILabeledRoundButton; 
