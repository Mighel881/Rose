...
@class IGUFIButtonBarView; @class UIView; @class SPTNowPlayingPreviousTrackButton; @class CNContactListTableViewCell; @class SPTGaiaDevicesAvailableViewImplementation; @class CCUILabeledRoundButton; @class SBIconController; @class AWEFeedVideoButton; @class SPTNowPlayingSliderV2; @class PHHandsetDialerNumberPadButton; @class SpringBoard; @class SPTNowPlayingPlayButtonV2; @class UICalloutBar; @class PHHandsetDialerDeleteButton; @class SBHIconManager; @class SBFolderView; @class SBUIIconForceTouchController; @class SBMainDisplaySceneManager; @class T1DirectMessageInboxSummaryView; @class SBUIController; @class SPTNowPlayingMarqueeLabel; @class CCUIToggleViewController; @class SBSleepWakeHardwareButtonInteraction; @class SBPowerDownViewController; @class VolumeControl; @class SBFolderController; @class SBControlCenterController; @class ICSApplicationDelegate; @class _UIButtonBarButton; @class SBPowerDownController; @class _SFNavigationBarURLButton; @class PHBottomBarButton; @class UIWindow; @class UIImageView; @class SPTNowPlayingFreeTierFeedbackButton; @class NSProcessInfo; @class T1ActivityCell; @class SBBacklightController; @class SPTNowPlayingNextTrackButton; @class SBUIPasscodeLockViewBase; @class SPTNowPlayingShuffleButton; @class UIStackView; @class MTMaterialView; @class SBAppSwitcherPageView; @class UIKeyboardLayoutStar; @class UIVisualEffectView; @class UIButton; @class SSScreenCapturer; @class SBCoverSheetPrimarySlidingViewController; @class T1StandardStatusView; @class SBDashBoardViewController; @class SBDashBoardMesaUnlockBehavior; @class SBSearchScrollView; @class TFNFloatingActionButton; @class SBVolumeControl; @class UILabel; @class SiriUISiriStatusView; @class SPTNowPlayingRepeatButton; @class SPTNowPlayingQueueButton; @class UIKBTree; @class TFNCustomTabBar; 
...
static __attribute__((constructor)) void _logosLocalCtor_4070643d(int __unused argc, char __unused **argv, char __unused **envp) {
...
static __attribute__((constructor)) void _logosLocalCtor_db978cb0(int __unused argc, char __unused **argv, char __unused **envp) {
