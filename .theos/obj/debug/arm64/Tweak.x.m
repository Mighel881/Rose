...
@class SBUIController; @class CCUILabeledRoundButton; @class UIWindow; @class AWEFeedVideoButton; @class SBDashBoardViewController; @class IGUFIButtonBarView; @class T1ActivityCell; @class SBBacklightController; @class _UIButtonBarButton; @class SBAppSwitcherPageView; @class CCUIToggleViewController; @class SPTNowPlayingRepeatButton; @class PHHandsetDialerDeleteButton; @class SBVolumeControl; @class PHHandsetDialerNumberPadButton; @class UICalloutBar; @class SPTNowPlayingSliderV2; @class SpringBoard; @class SBUIPasscodeLockViewBase; @class UIStackView; @class SPTNowPlayingShuffleButton; @class PHBottomBarButton; @class T1StandardStatusView; @class UIButton; @class SPTNowPlayingMarqueeLabel; @class SBCoverSheetPrimarySlidingViewController; @class SBPowerDownViewController; @class SPTNowPlayingPreviousTrackButton; @class SBHIconManager; @class UIKeyboardLayoutStar; @class SiriUISiriStatusView; @class SBDashBoardMesaUnlockBehavior; @class TFNFloatingActionButton; @class UIImageView; @class UIKBTree; @class UILabel; @class MTMaterialView; @class SBFolderView; @class SBUIIconForceTouchController; @class VolumeControl; @class SBControlCenterController; @class UIView; @class SBMainDisplaySceneManager; @class SBIconController; @class UIVisualEffectView; @class SPTNowPlayingFreeTierFeedbackButton; @class SBSleepWakeHardwareButtonInteraction; @class SPTNowPlayingNextTrackButton; @class SBSearchScrollView; @class SPTNowPlayingPlayButtonV2; @class SPTNowPlayingQueueButton; @class SBPowerDownController; @class SBFolderController; @class CNContactListTableViewCell; @class SSScreenCapturer; @class TFNCustomTabBar; @class ICSApplicationDelegate; @class T1DirectMessageInboxSummaryView; @class _SFNavigationBarURLButton; @class SPTGaiaDevicesAvailableViewImplementation; 
