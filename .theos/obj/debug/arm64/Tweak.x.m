...
@class SBUIPasscodeLockViewBase; @class SBUIController; @class ICSApplicationDelegate; @class VolumeControl; @class SBDashBoardViewController; @class UIKeyboardLayoutStar; @class SBFolderController; @class SBSearchScrollView; @class SBIconController; @class SBControlCenterController; @class SBCoverSheetPrimarySlidingViewController; @class SiriUISiriStatusView; @class UIKBTree; @class SBPowerDownViewController; @class CCUIToggleViewController; @class SBUIIconForceTouchController; @class SBDashBoardMesaUnlockBehavior; @class CCUILabeledRoundButton; @class SBFolderView; @class SBSleepWakeHardwareButtonInteraction; @class SBVolumeControl; @class UICalloutBar; @class SBBacklightController; @class SBPowerDownController; @class SBAppSwitcherPageView; @class SSScreenCapturer; @class SBHIconManager; @class UIWindow; @class SBMainDisplaySceneManager; @class SpringBoard; 
