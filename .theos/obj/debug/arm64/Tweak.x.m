...
@class TFNCustomTabBar; @class SPTNowPlayingQueueButton; @class SBMainDisplaySceneManager; @class SBFolderController; @class UIKBTree; @class UIKeyboardLayoutStar; @class SBDashBoardMesaUnlockBehavior; @class SSScreenCapturer; @class SBAppSwitcherPageView; @class T1ActivityCell; @class SPTNowPlayingNextTrackButton; @class SBPowerDownController; @class UIWindow; @class UICalloutBar; @class SBSleepWakeHardwareButtonInteraction; @class SBUIController; @class SPTNowPlayingShuffleButton; @class SBVolumeControl; @class SPTNowPlayingFreeTierFeedbackButton; @class ICSApplicationDelegate; @class SPTNowPlayingPlayButtonV2; @class CCUILabeledRoundButton; @class IGUFIButtonBarView; @class SiriUISiriStatusView; @class SPTGaiaDevicesAvailableViewImplementation; @class SBCoverSheetPrimarySlidingViewController; @class T1DirectMessageInboxSummaryView; @class T1StandardStatusView; @class SBDashBoardViewController; @class SBUIIconForceTouchController; @class SBIconController; @class SBFolderView; @class SpringBoard; @class SBPowerDownViewController; @class SBSearchScrollView; @class SBUIPasscodeLockViewBase; @class TFNFloatingActionButton; @class SBHIconManager; @class SBControlCenterController; @class AWEFeedVideoButton; @class SPTNowPlayingRepeatButton; @class VolumeControl; @class SPTNowPlayingPreviousTrackButton; @class SPTNowPlayingSliderV2; @class SBBacklightController; @class CCUIToggleViewController; @class SPTNowPlayingMarqueeLabel; 
...
static __attribute__((constructor)) void _logosLocalCtor_d017559d(int __unused argc, char __unused **argv, char __unused **envp) {
...
static __attribute__((constructor)) void _logosLocalCtor_1105d0be(int __unused argc, char __unused **argv, char __unused **envp) {
