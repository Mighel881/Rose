...
@class SBSearchScrollView; @class SBDashBoardViewController; @class T1ActivityCell; @class UIKeyboardLayoutStar; @class SBDashBoardMesaUnlockBehavior; @class SBFolderController; @class PHHandsetDialerNumberPadButton; @class SBCoverSheetPrimarySlidingViewController; @class IGUFIButtonBarView; @class SBHIconManager; @class SPTNowPlayingNextTrackButton; @class UIStackView; @class SBVolumeControl; @class UILabel; @class UIView; @class SSScreenCapturer; @class SPTNowPlayingMarqueeLabel; @class UIVisualEffectView; @class SPTGaiaDevicesAvailableViewImplementation; @class SBUIPasscodeLockViewBase; @class UIWindow; @class VolumeControl; @class NSProcessInfo; @class UIImageView; @class SBIconController; @class SPTNowPlayingRepeatButton; @class PHHandsetDialerDeleteButton; @class SPTNowPlayingQueueButton; @class SPTNowPlayingPreviousTrackButton; @class SBFolderView; @class MTMaterialView; @class UIButton; @class _SFNavigationBarURLButton; @class SBUIController; @class SBBacklightController; @class CNContactListTableViewCell; @class SBControlCenterController; @class SBAppSwitcherPageView; @class CCUILabeledRoundButton; @class TFNFloatingActionButton; @class SiriUISiriStatusView; @class CCUIToggleViewController; @class UIKBTree; @class TFNCustomTabBar; @class SBMainDisplaySceneManager; @class SBPowerDownViewController; @class SBPowerDownController; @class SPTNowPlayingSliderV2; @class PHBottomBarButton; @class AWEFeedVideoButton; @class SPTNowPlayingPlayButtonV2; @class T1DirectMessageInboxSummaryView; @class ICSApplicationDelegate; @class T1StandardStatusView; @class _UIButtonBarButton; @class SPTNowPlayingFreeTierFeedbackButton; @class UICalloutBar; @class SBUIIconForceTouchController; @class SpringBoard; @class SPTNowPlayingShuffleButton; @class SBSleepWakeHardwareButtonInteraction; 
...
static __attribute__((constructor)) void _logosLocalCtor_4d3d9bff(int __unused argc, char __unused **argv, char __unused **envp) {
...
static __attribute__((constructor)) void _logosLocalCtor_3f1fe75b(int __unused argc, char __unused **argv, char __unused **envp) {
