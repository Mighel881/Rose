...
@class SBCoverSheetPrimarySlidingViewController; @class SBUIIconForceTouchController; @class SBAppSwitcherPageView; @class SBPowerDownController; @class SBMainDisplaySceneManager; @class SBUIController; @class SpringBoard; @class VolumeControl; @class SiriUISiriStatusView; @class SBSleepWakeHardwareButtonInteraction; 
