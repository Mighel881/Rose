...
@class SBBacklightController; @class SBDashBoardViewController; @class CCUILabeledRoundButton; @class SBIconController; @class SpringBoard; @class UICalloutBar; @class VolumeControl; @class ICSApplicationDelegate; @class SBFolderController; @class SiriUISiriStatusView; @class SBAppSwitcherPageView; @class SBVolumeControl; @class SBCoverSheetPrimarySlidingViewController; @class UIKeyboardLayoutStar; @class SBUIController; @class SSScreenCapturer; @class UIWindow; @class UIKBTree; @class SBSearchScrollView; @class SBMainDisplaySceneManager; @class SBSleepWakeHardwareButtonInteraction; @class SBFolderView; @class SBUIIconForceTouchController; @class SBPowerDownController; @class SBDashBoardMesaUnlockBehavior; @class SBUIPasscodeLockViewBase; @class SBHIconManager; @class SBPowerDownViewController; 
