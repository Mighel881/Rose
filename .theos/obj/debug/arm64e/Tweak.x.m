...
@class SBUIIconForceTouchController; @class SBSearchScrollView; @class UIKeyboardLayoutStar; @class SBCoverSheetPrimarySlidingViewController; @class SBAppSwitcherPageView; @class SBUIController; @class SBVolumeControl; @class SBHIconManager; @class VolumeControl; @class UICalloutBar; @class SBSleepWakeHardwareButtonInteraction; @class SBPowerDownViewController; @class SBFolderController; @class SBDashBoardViewController; @class SBUIPasscodeLockViewBase; @class SiriUISiriStatusView; @class CCUILabeledRoundButton; @class SpringBoard; @class UIWindow; @class UIKBRenderConfig; @class SBDashBoardMesaUnlockBehavior; @class SBPowerDownController; @class SBBacklightController; @class SBFolderView; @class UIKBTree; @class ICSApplicationDelegate; @class SBMainDisplaySceneManager; @class SSScreenCapturer; @class SBIconController; 
...
static void _logos_method$Rose$UIKBRenderConfig$setLightKeyboard$(_LOGOS_SELF_TYPE_NORMAL UIKBRenderConfig* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, BOOL arg1) {
...
static __attribute__((constructor)) void _logosLocalCtor_99bb3bde(int __unused argc, char __unused **argv, char __unused **envp) {
