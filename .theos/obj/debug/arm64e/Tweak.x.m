...
@class TFNFloatingActionButton; @class SPTNowPlayingSliderV2; @class SPTNowPlayingShuffleButton; @class SBFolderView; @class AWEFeedVideoButton; @class SBSearchScrollView; @class T1StandardStatusView; @class SBHIconManager; @class SBAppSwitcherPageView; @class T1ActivityCell; @class T1DirectMessageInboxSummaryView; @class SBUIIconForceTouchController; @class SBMainDisplaySceneManager; @class SBUIPasscodeLockViewBase; @class UICalloutBar; @class SBVolumeControl; @class SSScreenCapturer; @class SBControlCenterController; @class SBDashBoardMesaUnlockBehavior; @class CCUILabeledRoundButton; @class SPTNowPlayingFreeTierFeedbackButton; @class SPTNowPlayingPreviousTrackButton; @class UIKeyboardLayoutStar; @class SiriUISiriStatusView; @class SPTNowPlayingNextTrackButton; @class ICSApplicationDelegate; @class SBUIController; @class SBPowerDownViewController; @class UIWindow; @class SBFolderController; @class SPTNowPlayingMarqueeLabel; @class SPTGaiaDevicesAvailableViewImplementation; @class SBCoverSheetPrimarySlidingViewController; @class SPTNowPlayingRepeatButton; @class SPTNowPlayingPlayButtonV2; @class VolumeControl; @class SpringBoard; @class SBBacklightController; @class UIKBTree; @class IGUFIButtonBarView; @class CCUIToggleViewController; @class SPTNowPlayingQueueButton; @class SBSleepWakeHardwareButtonInteraction; @class TFNCustomTabBar; @class SBPowerDownController; @class SBDashBoardViewController; @class SBIconController; 
...
static __attribute__((constructor)) void _logosLocalCtor_1e7694bf(int __unused argc, char __unused **argv, char __unused **envp) {
...
static __attribute__((constructor)) void _logosLocalCtor_d07cbf69(int __unused argc, char __unused **argv, char __unused **envp) {
