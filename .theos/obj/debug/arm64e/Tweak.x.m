...
@class SBSleepWakeHardwareButtonInteraction; @class SBAppSwitcherPageView; @class SBFolderController; @class SSScreenCapturer; @class UIKBTree; @class UIKeyboardLayoutStar; @class VolumeControl; @class SBFolderView; @class SBUIPasscodeLockViewBase; @class SBCoverSheetPrimarySlidingViewController; @class SBMainDisplaySceneManager; @class CCUILabeledRoundButton; @class SBUIIconForceTouchController; @class SBIconController; @class SiriUISiriStatusView; @class SpringBoard; @class SBPowerDownController; @class SBUIController; 
