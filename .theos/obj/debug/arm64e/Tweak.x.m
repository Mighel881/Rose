...
@class SBUIController; @class SBCoverSheetPrimarySlidingViewController; @class SBBacklightController; @class SBSearchScrollView; @class UIKeyboardLayoutStar; @class SSScreenCapturer; @class SBUIIconForceTouchController; @class SiriUISiriStatusView; @class SBFolderController; @class UICalloutBar; @class SpringBoard; @class CCUILabeledRoundButton; @class UIKBTree; @class SBIconController; @class ICSApplicationDelegate; @class SBFolderView; @class SBMainDisplaySceneManager; @class SBDashBoardViewController; @class VolumeControl; @class SBUIPasscodeLockViewBase; @class SBPowerDownController; @class UIWindow; @class SBSleepWakeHardwareButtonInteraction; @class SBAppSwitcherPageView; 
...
static __attribute__((constructor)) void _logosLocalCtor_ed8ce231(int __unused argc, char __unused **argv, char __unused **envp) {
