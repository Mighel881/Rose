...
@class PHHandsetDialerDeleteButton; @class SPTNowPlayingMarqueeLabel; @class SBUIController; @class T1ActivityCell; @class SPTNowPlayingRepeatButton; @class SPTNowPlayingFreeTierFeedbackButton; @class SBCoverSheetPrimarySlidingViewController; @class SBPowerDownController; @class _SFNavigationBarURLButton; @class PHBottomBarButton; @class UIWindow; @class SBVolumeControl; @class SBFolderView; @class SBSleepWakeHardwareButtonInteraction; @class TFNFloatingActionButton; @class ICSApplicationDelegate; @class T1DirectMessageInboxSummaryView; @class UIKeyboardLayoutStar; @class SBFolderController; @class SBDashBoardMesaUnlockBehavior; @class UIKBTree; @class SBAppSwitcherPageView; @class SpringBoard; @class SBMainDisplaySceneManager; @class VolumeControl; @class SBControlCenterController; @class SPTNowPlayingQueueButton; @class TFNCustomTabBar; @class SBSearchScrollView; @class T1StandardStatusView; @class SBDashBoardViewController; @class SBPowerDownViewController; @class SPTNowPlayingNextTrackButton; @class SBBacklightController; @class UICalloutBar; @class SiriUISiriStatusView; @class SPTNowPlayingPreviousTrackButton; @class SPTNowPlayingPlayButtonV2; @class SPTNowPlayingSliderV2; @class AWEFeedVideoButton; @class CNContactListTableViewCell; @class CCUIToggleViewController; @class SPTNowPlayingShuffleButton; @class SBIconController; @class SBUIIconForceTouchController; @class IGUFIButtonBarView; @class SSScreenCapturer; @class CCUILabeledRoundButton; @class SBUIPasscodeLockViewBase; @class SPTGaiaDevicesAvailableViewImplementation; @class SBHIconManager; @class PHHandsetDialerNumberPadButton; 
