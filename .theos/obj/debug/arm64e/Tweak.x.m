...
@class SBVolumeControl; @class SBFolderController; @class SBDashBoardMesaUnlockBehavior; @class SBPowerDownViewController; @class UIWindow; @class SBUIPasscodeLockViewBase; @class SBSleepWakeHardwareButtonInteraction; @class SBCoverSheetPrimarySlidingViewController; @class UICalloutBar; @class UIKBTree; @class CCUIToggleViewController; @class SiriUISiriStatusView; @class SBDashBoardViewController; @class CCUILabeledRoundButton; @class ICSApplicationDelegate; @class SBBacklightController; @class SBUIIconForceTouchController; @class SBFolderView; @class SBMainDisplaySceneManager; @class SSScreenCapturer; @class UIKeyboardLayoutStar; @class SBSearchScrollView; @class SBControlCenterController; @class SBHIconManager; @class SBPowerDownController; @class SBUIController; @class SBIconController; @class SpringBoard; @class SBAppSwitcherPageView; @class VolumeControl; 
...
static __attribute__((constructor)) void _logosLocalCtor_533cd50f(int __unused argc, char __unused **argv, char __unused **envp) {
...
static __attribute__((constructor)) void _logosLocalCtor_4b1eb221(int __unused argc, char __unused **argv, char __unused **envp) {
