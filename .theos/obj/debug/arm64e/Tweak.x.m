...
@class T1ActivityCell; @class SPTNowPlayingRepeatButton; @class TFNFloatingActionButton; @class SBDashBoardMesaUnlockBehavior; @class SBVolumeControl; @class SPTGaiaDevicesAvailableViewImplementation; @class SPTNowPlayingShuffleButton; @class SiriUISiriStatusView; @class SBIconController; @class CCUIToggleViewController; @class SBFolderView; @class SBHIconManager; @class SSScreenCapturer; @class ICSApplicationDelegate; @class CCUILabeledRoundButton; @class SBDashBoardViewController; @class SPTNowPlayingFreeTierFeedbackButton; @class SBBacklightController; @class SPTNowPlayingMarqueeLabel; @class UIKeyboardLayoutStar; @class TFNCustomTabBar; @class SBMainDisplaySceneManager; @class SBCoverSheetPrimarySlidingViewController; @class SPTNowPlayingNextTrackButton; @class IGUFIButtonBarView; @class SPTNowPlayingPlayButtonV2; @class SpringBoard; @class UICalloutBar; @class SBSleepWakeHardwareButtonInteraction; @class SBPowerDownViewController; @class SBControlCenterController; @class UIWindow; @class SBFolderController; @class T1DirectMessageInboxSummaryView; @class SPTNowPlayingPreviousTrackButton; @class SBPowerDownController; @class SBUIController; @class UIKBTree; @class SBSearchScrollView; @class SBUIPasscodeLockViewBase; @class AWEFeedVideoButton; @class SPTNowPlayingSliderV2; @class SBAppSwitcherPageView; @class SPTNowPlayingQueueButton; @class SBUIIconForceTouchController; @class VolumeControl; @class T1StandardStatusView; 
