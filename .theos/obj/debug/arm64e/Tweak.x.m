...
@class VolumeControl; @class SBIconController; @class SBUIPasscodeLockViewBase; @class SBFolderView; @class SBFolderController; @class SiriUISiriStatusView; @class SBPowerDownController; @class SpringBoard; @class UIKBTree; @class UIKeyboardLayoutStar; @class SSScreenCapturer; @class CCUILabeledRoundButton; @class SBAppSwitcherPageView; @class SBSleepWakeHardwareButtonInteraction; @class SBCoverSheetPrimarySlidingViewController; @class SBUIIconForceTouchController; @class SBUIController; @class SBMainDisplaySceneManager; 
...
static __attribute__((constructor)) void _logosLocalCtor_7d2a5c70(int __unused argc, char __unused **argv, char __unused **envp) {
