...
@class SBUIController; @class CUShutterButton; @class SBCoverSheetPrimarySlidingViewController; @class SiriUISiriStatusView; @class SBUIIconForceTouchController; @class SBMainDisplaySceneManager; @class SBFolderView; @class SpringBoard; @class VolumeControl; @class SBSleepWakeHardwareButtonInteraction; @class SBFolderController; @class SBPowerDownController; @class CCUILabeledRoundButton; @class SBIconController; @class SBAppSwitcherPageView; 
