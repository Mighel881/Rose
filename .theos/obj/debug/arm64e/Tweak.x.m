...
@class SBFolderController; @class VolumeControl; @class SpringBoard; @class SBUIPasscodeLockViewBase; @class SBCoverSheetPrimarySlidingViewController; @class SBSearchScrollView; @class UIKeyboardLayoutStar; @class ICSApplicationDelegate; @class SBUIController; @class UIKBTree; @class SBDashBoardViewController; @class SiriUISiriStatusView; @class SBDashBoardMesaUnlockBehavior; @class SBSleepWakeHardwareButtonInteraction; @class UIWindow; @class SBAppSwitcherPageView; @class SBUIIconForceTouchController; @class SBBacklightController; @class SBMainDisplaySceneManager; @class SBPowerDownViewController; @class SBVolumeControl; @class UICalloutBar; @class SBFolderView; @class SSScreenCapturer; @class SBPowerDownController; @class SBHIconManager; @class SBIconController; @class CCUILabeledRoundButton; 
