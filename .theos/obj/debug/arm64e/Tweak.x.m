...
@class SBFolderView; @class UIKBTree; @class CCUILabeledRoundButton; @class SBPowerDownController; @class UIImageView; @class SBAppSwitcherPageView; @class IGUFIButtonBarView; @class UIStackView; @class SBControlCenterController; @class SBFolderController; @class ICSApplicationDelegate; @class SPTGaiaDevicesAvailableViewImplementation; @class UIKeyboardLayoutStar; @class SBDashBoardMesaUnlockBehavior; @class UICalloutBar; @class SBUIController; @class T1DirectMessageInboxSummaryView; @class SPTNowPlayingSliderV2; @class UIView; @class SBVolumeControl; @class SBPowerDownViewController; @class SPTNowPlayingFreeTierFeedbackButton; @class UIWindow; @class SBCoverSheetPrimarySlidingViewController; @class SPTNowPlayingPreviousTrackButton; @class _UIButtonBarButton; @class TFNCustomTabBar; @class UILabel; @class SPTNowPlayingNextTrackButton; @class SBDashBoardViewController; @class CCUIToggleViewController; @class T1ActivityCell; @class T1StandardStatusView; @class PHHandsetDialerDeleteButton; @class PHBottomBarButton; @class SiriUISiriStatusView; @class SBUIIconForceTouchController; @class SSScreenCapturer; @class SBSearchScrollView; @class PHHandsetDialerNumberPadButton; @class NSProcessInfo; @class _SFNavigationBarURLButton; @class SBSleepWakeHardwareButtonInteraction; @class VolumeControl; @class CNContactListTableViewCell; @class TFNFloatingActionButton; @class UIButton; @class SpringBoard; @class UIVisualEffectView; @class SPTNowPlayingQueueButton; @class SBBacklightController; @class SPTNowPlayingShuffleButton; @class SPTNowPlayingRepeatButton; @class SBIconController; @class AWEFeedVideoButton; @class SBUIPasscodeLockViewBase; @class SPTNowPlayingMarqueeLabel; @class SBHIconManager; @class SPTNowPlayingPlayButtonV2; @class SBMainDisplaySceneManager; @class MTMaterialView; 
