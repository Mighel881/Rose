#import "RSEFacebookSubPrefsListController.h"

BOOL enableFacebookSection = NO;

@implementation RSEFacebookSubPrefsListController
...
- (void)toggleState {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/sh.litten.rosepreferences.plist"]) {
        enableFacebookSection = YES;
        [preferences setBool:enableFacebookSection forKey:@"EnableFacebookSection"];
        [self toggleCellState:YES];
    } else if (![allKeys containsObject:@"EnableFacebookSection"]) {
        enableFacebookSection = YES;
        [preferences setBool:enableFacebookSection forKey:@"EnableFacebookSection"];
        [self toggleCellState:YES];
    } else if ([[preferences objectForKey:@"EnableFacebookSection"] isEqual:@(NO)]) {
        enableFacebookSection = YES;
        [preferences setBool:enableFacebookSection forKey:@"EnableFacebookSection"];
        [self toggleCellState:YES];   
    } else if ([[preferences objectForKey:@"EnableFacebookSection"] isEqual:@(YES)]) {
        enableFacebookSection = NO;
        [preferences setBool:enableFacebookSection forKey:@"EnableFacebookSection"];
