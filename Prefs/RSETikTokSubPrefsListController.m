#import "RSETikTokSubPrefsListController.h"

BOOL enableTikTokSection = NO;

@implementation RSETikTokSubPrefsListController
...
- (void)toggleState {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/sh.litten.rosepreferences.plist"]) {
        enableTikTokSection = YES;
        [preferences setBool:enableTikTokSection forKey:@"EnableTikTokSection"];
        [self toggleCellState:YES];
    } else if (![allKeys containsObject:@"EnableTikTokSection"]) {
        enableTikTokSection = YES;
        [preferences setBool:enableTikTokSection forKey:@"EnableTikTokSection"];
        [self toggleCellState:YES];
    } else if ([[preferences objectForKey:@"EnableTikTokSection"] isEqual:@(NO)]) {
        enableTikTokSection = YES;
        [preferences setBool:enableTikTokSection forKey:@"EnableTikTokSection"];
        [self toggleCellState:YES];   
    } else if ([[preferences objectForKey:@"EnableTikTokSection"] isEqual:@(YES)]) {
        enableTikTokSection = NO;
        [preferences setBool:enableTikTokSection forKey:@"EnableTikTokSection"];
